      ...
      >
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10"> 
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Founded in the year 2020 by a team of passionate explorers, The Travel Group was born from a simple idea: travel should be extraordinary, accessible, and completely hassle-free. We were tired of cookie-cutter tours and impersonal service. We believed we could do better.
          </motion.p>
          <motion.p 
