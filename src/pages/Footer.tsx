...
// We can add hover animations to these!
      ...
      <div className="container mx-auto max-w-7xl px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h2 className="text-3xl font-heading font-bold mb-4">The Travel Group</h2>
            <p className="text-gray-300">Your next adventure is just a click away.</p>
          </div>

          {/* Column 2: Quick Links */}
          <div>
            <h3 className="text-lg font-heading font-semibold mb-4 text-accent">Quick Links</h3>
            <ul className="space-y-2">
              <li><Link to="/" className="hover:text-accent transition-colors">Home</Link></li>
              <li><Link to="/packages" className="hover:text-accent transition-colors">Packages</Link></li>
              <li><Link to="/enquiry" className="hover:text-accent transition-colors">Enquiry</Link></li>
          ...
          {/* Column 3: Contact */}
          <div>
            <h3 className="text-lg font-heading font-semibold mb-4 text-accent">Contact Us</h3>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-teal-500 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} The Travel Group. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
